...
public class WinningNumbersListTable {
    ...
    public static ResultSet selectAll() {
        try {
            Connection connection = DbConnect.connect();   
            Statement statement = connection.createStatement();
            String selectSQL = "(select * from winningNumbersList)";
    ...
    public static void insertData (int number1,int number2 ,int number3, int number4, int number5, int bonus,  int gameId, int drawId) {
        try {
            Connection connection = DbConnect.connect();
            String insertSQL = "INSERT INTO winningNumbersList ("
                    + "number1,"
                    + "number2,"
                    + "number3,"
                    + "number4,"
    ...
    public static void updateData (int number1, int number2 ,int number3, int number4, int number5, int bonus,  int gameId, int drawId) {
        try {
            Connection connection = DbConnect.connect();
            String updateSQL = "UPDATE winningNumbersList SET"
                    + "number1 = ?,"
                    + "number2 = ?,"
                    + "number3 = ?,"
                    + "number4 = ?,"
    ...
    public static void deleteTupple (int gameId, int drawId) {
        try {
            Connection connection = DbConnect.connect();
            String deleteSQL = "DELETE FROM winningNumbersList WHERE gameID = ? AND drawID = ?;";
    ...
    public static void deleteGameData (int gameId) {
        try {
            Connection connection = DbConnect.connect();
            String deleteSQL = "DELETE FROM winningNumbersList WHERE gameID = ?;";
            PreparedStatement preparedStatement = connection.prepareStatement(deleteSQL);
            preparedStatement.setInt(1, gameId);
            preparedStatement.executeUpdate();
            preparedStatement.close();
