...
public class WindowManageData
{
	...
	public WindowManageData()
	{
		...
		// Labels
		JLabel label = new JLabel("Διαχείριση δεδομένων");
		label.setFont(new Font("Arial", 3, 42));
		label.setForeground(Color.ORANGE);

		JLabel labelShadow = new JLabel("Διαχείριση δεδομένων");
		...
		topPanel.setPreferredSize(new java.awt.Dimension(514, 89));
		topPanel.setMinimumSize(new java.awt.Dimension(514, 89));
		topPanel.setMaximumSize(new java.awt.Dimension(514, 89));
