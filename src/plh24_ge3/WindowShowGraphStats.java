...
//		dialog.setResizable(false);
         ...
         private void buttonDisplayActionPerformed1(java.awt.event.ActionEvent evt)
        {
            ...
            try {
                    ...
                    List<Integer> occurency = new ArrayList<Integer>();
                                     
                    for(int i=1; i<=45; i++){
                        numbers.add(i);
                        int num = QueriesSQL.singleNumberOccurrences(textFieldDate1.getText().toString(), textFieldDate2.getText().toString(), i);
                        occurency.add(num);
                    }
                    System.out.println("--------------------------");                  
                    for(int i=1; i<=45; i++){
                    ...
                    Graph_Form chart = new Graph_Form(
                        "Numbers Vs Occurencies" ,
                        "5 Most Occured Numbers",numbers, occurency);
         ...
         private void buttonDisplayActionPerformed2(java.awt.event.ActionEvent evt)
        {
                try {
                    ...
                    for(int i=1; i<=20; i++){
                        numbers.add(i);
                        int num = QueriesSQL.singleBonusOccurrences(textFieldDate1.getText().toString(), textFieldDate2.getText().toString(), i);
                        occurency.add(num);
                    }
                    System.out.println("--------------------------");                  
                    for(int i=1; i<=20; i++){
                    ...
                    Graph_Form chart = new Graph_Form(
                        ...
                        "5 Most Occured Joker Numbers",numbers, occurency);
